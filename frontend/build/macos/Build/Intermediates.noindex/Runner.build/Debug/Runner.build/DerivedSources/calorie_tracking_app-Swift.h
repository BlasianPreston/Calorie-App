...
#ifndef CALORIE_TRACKING_APP_SWIFT_H
#define CALORIE_TRACKING_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="calorie_tracking_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC20calorie_tracking_app11AppDelegate")
...
SWIFT_CLASS("_TtC20calorie_tracking_app17MainFlutterWindow")
